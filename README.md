...
<img width="800" height="450" alt="video_clip" src="https://github.com/user-attachments/assets/7c87b1de-d0c3-44e1-aab7-3b3da01bf3cf" />
...
- `PLAY` avvia la run roguelite normale.
- `TUTORIAL` apre un percorso guidato su movimento, combattimento, pickup,
  tomi, piazzabili, settori e chest.
- `STAGING` e' disponibile soltanto con il server Vite di sviluppo e apre una
  console per spawn, build, wave, effetti, mappe e preset di test.
- Il pannello staging si comprime dal pulsante in alto o con il tasto
  backtick.
...
preload();
{
  ...
  this.load.image("icon-magnet", "assets/images/magnet.png");
  this.load.image("icon-venom", "assets/images/venom.png");
}
```
